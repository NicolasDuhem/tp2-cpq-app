...
const entries: UiDocEntry[] = [
  ...
  },
  {
    ...
    purpose:
      'Provides one dynamic filter group per feature with multi-select values generated from current generated combinations.',
    codeSource: 'components/cpq/bike-builder-page.tsx',
    dataSource: 'featureFilterGroups derived from combinationDataset.columns + combinationDataset.rows.',
    notes: 'Filtering uses OR logic inside each feature and AND logic across features.',
  },
  {
    page: 'CPQ - Bike Builder',
    section: 'Generated combinations',
    subsection: 'Grid controls',
    label: 'Select all visible rows / Unselect all visible rows',
    purpose: 'Bulk-selects or bulk-unselects only the currently visible filtered rows.',
    codeSource: 'components/cpq/bike-builder-page.tsx',
    dataSource: 'visibleRowIdSet built from filteredCombinationRows.',
    notes: 'Designed for operational workflow after narrowing the data with filters.',
  },
  {
    page: 'CPQ - Bike Builder',
    section: 'Generated combinations',
    subsection: 'Country assignments',
    label: 'Tick/Untick selected countries on visible rows',
    purpose: 'Bulk applies country checkboxes to all visible selected rows.',
    codeSource: 'components/cpq/bike-builder-page.tsx',
    dataSource: 'selectedBulkCountryCodes + visibleRowIdSet + row.selected state.',
    notes: 'Does not change bulk execution model; it only speeds preparation.',
  },
  {
    page: 'CPQ - Bike Builder',
    section: 'Generated combinations',
