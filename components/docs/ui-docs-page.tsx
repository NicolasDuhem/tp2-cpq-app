...
const entries: UiDocEntry[] = [
  ...
  },
  {
    ...
    codeSource: 'components/cpq/bike-builder-page.tsx',
    dataSource: 'Local row diagnostics state fed by Bulk API requests/responses.',
    notes: 'Failure modal includes stage, summary, trace/session IDs, and last 2 requests/responses.',
  },
  {
    page: 'CPQ - Bike Builder',
    section: 'Generated combinations',
    ...
    purpose: 'After bulk completion only originally ticked rows remain in table data.',
    codeSource: 'components/cpq/bike-builder-page.tsx',
    dataSource: 'combinationDataset.rows reduced to selected set after run.',
    notes: 'Unticked rows are removed from visible dataset post-run.',
  },
  {
    page: 'CPQ Setup',
    section: 'Picture management',
