...
- `ARCHITECTURE.md`: retained routes, APIs, and runtime boundaries.
...
- `PROCESSDATA.md`: retained process flows and API/table interactions, including the single dynamic traversal workflow.
